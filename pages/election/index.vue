            ...
            >
              <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                >
                  ...
                  Welcome to Nimelssa E-Voting Plattform 2024
                </h1>
                <p
                  class="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none"
                >
                  We’re changing the way Nimelssaite elect i's candidates and foster inclusiveness.
                </p>
    ...
    <div class="py-24 sm:py-32 lg:pb-40">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">NIMELSSA ELECTIONS 2024</h1>
