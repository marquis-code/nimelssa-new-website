            ...
            >
              <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                >
                  ...
                  Welcome to NIMELSSA E-Voting Platform 2024
                </h1>
                <p
                  class="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none"
                >
                 Empowering Your Voice and Shaping Our Future, The NIMELSSA'n Way!
                </p>
...
export default {
  head: {
    title: 'NIMELSSA Election',
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: 'NIMELSSA Election'
      }
    ]
  }
}
